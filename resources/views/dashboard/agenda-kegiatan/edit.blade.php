    ...
    <div class="w-full">
        ...
        <div class="card overflow-hidden p-5">
            <div class="card-header flex justify-between items-center">
                <h4 class="card-title">Edit Agenda Kegiatan</h4>
            </div>
            <div class="card-body mt-5">
                <form action="{{ route('dashboard.agenda-kegiatan.update', $agenda->id) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" id="slug" class="form-input bg-cyan-300" readonly=""
                                value="{{ $agenda->slug }}" required name="slug" style="cursor: not-allowed;">
                        </div>
                        @if ($agenda->image)
                            <img src="{{ asset('storage/' . $agenda->image) }}" alt="" class="w-36"
                                id="img-priview">
                        @endif
                        <div>

                            <input type="hidden" value="{{ $agenda->image }}" name="old_image" id="old_image">
                    ...
                    <textarea id="editor" class="ckeditor" name="body">{{ $agenda->body }}</textarea>
